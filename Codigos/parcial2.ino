...
//========================= Pines L298N =====================================
// Dirección (IN1..IN4)
const int IN1_PIN = 25;   // Motor A
const int IN2_PIN = 26;   // Motor A
const int IN3_PIN = 32;   // Motor B
const int IN4_PIN = 33;   // Motor B
// Enables (PWM)
const int ENA_PIN = 27;   // L298N ENA -> GPIO27
const int ENB_PIN = 13;   // L298N ENB -> GPIO13

//========================= PWM =============================================
const int FREQ = 2000;     // 2 kHz
...
// Zona muerta y “kick”
const int MIN_DUTY_MOVE = 110;  // ~43%
const int KICK_MS       = 60;   // impulso de arranque

// Velocidad seleccionada y giros (misma lógica)
int dutySel   = DUTY_100;   // 10..100%
int dutyGiros = DUTY_50;    // recalculado

// Auto-stop por duración
unsigned long cmdEndMillis = 0; // 0 = sin comando activo

//========================= MQTT ============================================
// Broker público de ejemplo (puedes cambiarlo)
...
const unsigned long MQTT_RETRY_EVERY_MS = 5000; // reintento cada 5s
...
void mqttEnsureConnected() {
  ...
  if (now - mqttLastRetryMs < MQTT_RETRY_EVERY_MS) return;
  mqttLastRetryMs = now;
